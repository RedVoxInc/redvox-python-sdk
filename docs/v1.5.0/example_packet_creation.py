...
# Example timestamps and payload for location channel
...
# Example timestamps and payload for XYZ channels such as accelerometer, magnetometer, and gyroscope
example_xyz_timestamps = [1, 2, 3]
example_x_payload = [1, 2, 3]
example_y_payload = [4, 5, 6]
example_z_payload = [7, 8, 9]

# The high level API provides setters and constructors for all metadata and sensor channel. Below is an example of
...
example_packet.set_microphone_channel(microphone_sensor)
...
example_packet.set_barometer_channel(barometer_sensor)
...
example_packet.set_location_channel(location_sensor)
...
example_packet.set_time_synchronization_channel(time_synchronization_sensor)
...
accelerometer_sensor.set_payload_values(example_x_payload,
                                        example_y_payload,
                                        example_z_payload)
example_packet.set_accelerometer_channel(accelerometer_sensor)
...
magnetometer_sensor.set_payload_values(example_x_payload,
                                       example_y_payload,
                                       example_z_payload)
example_packet.set_magnetometer_channel(magnetometer_sensor)
...
gyroscope_sensor.set_payload_values(example_x_payload,
                                    example_y_payload,
                                    example_z_payload)
example_packet.set_gyroscope_channel(gyroscope_sensor)
...
example_packet.set_light_channel(light_sensor)
...
example_packet.set_infrared_channel(infrared_sensor)
...
example_packet_2 = reader.WrappedRedvoxPacket() \
    ...
    .set_microphone_channel(reader.MicrophoneSensor()
    ...
    .set_location_channel(reader.LocationSensor()
                          ...
                          .set_payload_values(example_latitude_payload,
                                              ...
                                              example_speed_payload,
                                              example_accuracy_payload)) \
    .set_time_synchronization_channel(reader.TimeSynchronizationSensor()
                                      .set_payload_values(example_scalar_payload)) \
    .set_accelerometer_channel(reader.AccelerometerSensor()
                               ...
                               .set_payload_values(example_x_payload,
                                                   example_y_payload,
                                                   example_z_payload)) \
    .set_magnetometer_channel(reader.MagnetometerSensor().set_sensor_name("example_magnetometer")
                              .set_timestamps_microseconds_utc(example_xyz_timestamps)
                              .set_payload_values(example_x_payload,
                                                  example_y_payload,
                                                  example_z_payload)) \
    .set_gyroscope_channel(reader.GyroscopeSensor().set_sensor_name("example_gyroscope")
                           .set_timestamps_microseconds_utc(example_xyz_timestamps)
                           .set_payload_values(example_x_payload,
                                               example_y_payload,
                                               example_z_payload)) \
