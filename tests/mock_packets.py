...
def set_payload(redvox_channel: typing.Union[io.redvox.api900.api900_pb2.EvenlySampledChannel,
                                             io.redvox.api900.api900_pb2.UnevenlySampledChannel],
                payload_type: typing.Type,
                payload: typing.List) -> typing.Union[io.redvox.api900.api900_pb2.EvenlySampledChannel,
                                                      io.redvox.api900.api900_pb2.UnevenlySampledChannel]:
...
def base_packet() -> io.redvox.api900.api900_pb2.RedvoxPacket:
    base_packet = io.redvox.api900.api900_pb2.RedvoxPacket()
...
def with_evenly_sampled_channel(redvox_packet: io.redvox.api900.api900_pb2.RedvoxPacket,
                                ...
                                metadata: typing.List[str]) -> io.redvox.api900.api900_pb2.RedvoxPacket:
    evenly_sampled_channel = io.redvox.api900.api900_pb2.EvenlySampledChannel()
...
def with_unevenly_sampled_channel(redvox_packet: io.redvox.api900.api900_pb2.RedvoxPacket,
                                  channel_types: typing.List[int],
                                  sensor_name: str,
                                  ...
                                  metadata: typing.List[str]) -> io.redvox.api900.api900_pb2.RedvoxPacket:
    unevenly_sampled_channel = io.redvox.api900.api900_pb2.UnevenlySampledChannel()
...
def simple_mic_packet():
    ...
    return with_evenly_sampled_channel(packet,
                                       [io.redvox.api900.api900_pb2.MICROPHONE],
...
def simple_unevenly_sampled_packet():
    return with_unevenly_sampled_channel(base_packet(),
                                         [io.redvox.api900.api900_pb2.OTHER],
