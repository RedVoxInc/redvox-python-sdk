...
class WrappedRedvoxPacketTests(ArraysTestCase):
    ...
    def test_get_channel(self):
        ...
        self.assertEqual(self.mic_packet.get_channel(api900_pb2.BAROMETER),
                         None)

        self.assertEqual(self.gps_packet.get_channel(api900_pb2.LATITUDE).sensor_name,
                         "test gps sensor name")
        self.assertEqual(self.gps_packet.get_channel(api900_pb2.LONGITUDE).sensor_name,
                         "test gps sensor name")
        self.assertEqual(self.gps_packet.get_channel(api900_pb2.SPEED).sensor_name,
                         "test gps sensor name")
        self.assertEqual(self.gps_packet.get_channel(api900_pb2.ALTITUDE).sensor_name,
                         "test gps sensor name")
        self.assertEqual(self.gps_packet.get_channel(api900_pb2.MICROPHONE), None)

        self.assertEqual(self.multi_packet.get_channel(api900_pb2.MICROPHONE).sensor_name,
                         "test microphone sensor name")
        self.assertEqual(self.multi_packet.get_channel(api900_pb2.LATITUDE).sensor_name,
                         "test gps sensor name")
        self.assertEqual(self.multi_packet.get_channel(api900_pb2.LONGITUDE).sensor_name,
                         "test gps sensor name")
        self.assertEqual(self.multi_packet.get_channel(api900_pb2.SPEED).sensor_name,
                         "test gps sensor name")
        self.assertEqual(self.multi_packet.get_channel(api900_pb2.ALTITUDE).sensor_name,
                         "test gps sensor name")
        self.assertEqual(self.multi_packet.get_channel(api900_pb2.OTHER).sensor_name,
                         "test other sensor name")

    def test_has_channel(self):
        self.assertTrue(self.mic_packet.has_channel(api900_pb2.MICROPHONE))
        self.assertFalse(self.mic_packet.has_channel(api900_pb2.BAROMETER))

        self.assertTrue(self.gps_packet.has_channel(api900_pb2.LATITUDE))
        self.assertTrue(self.gps_packet.has_channel(api900_pb2.LONGITUDE))
        self.assertTrue(self.gps_packet.has_channel(api900_pb2.SPEED))
        self.assertTrue(self.gps_packet.has_channel(api900_pb2.ALTITUDE))
        self.assertFalse(self.gps_packet.has_channel(api900_pb2.MICROPHONE))

        self.assertTrue(self.multi_packet.has_channel(api900_pb2.MICROPHONE))
        self.assertTrue(self.multi_packet.has_channel(api900_pb2.LATITUDE))
        self.assertTrue(self.multi_packet.has_channel(api900_pb2.LONGITUDE))
