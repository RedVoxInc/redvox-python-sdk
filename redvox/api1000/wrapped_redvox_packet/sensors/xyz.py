...
class XyzChannel(common.ProtoBase):
    def __init__(self, proto: redvox_api_1000_pb2.RedvoxPacketM.SensorChannels.XyzChannel):
    ...
    @staticmethod
    def new() -> 'XyzChannel':
        return XyzChannel(redvox_api_1000_pb2.RedvoxPacketM.SensorChannels.XyzChannel())
