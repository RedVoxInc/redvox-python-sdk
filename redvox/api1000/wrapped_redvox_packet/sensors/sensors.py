...
class Sensors(redvox.api1000.common.generic.ProtoBase[redvox_api_m_pb2.RedvoxPacketM.Sensors]):
    ...
    __ACCELEROMETER_FIELD_NAME: Literal[b"accelerometer"] = b"accelerometer"
    __AMBIENT_TEMPERATURE_FIELD_NAME: Literal[b"ambient_temperature"] = b"ambient_temperature"
    __AUDIO_FIELD_NAME: Literal[b"audio"] = b"audio"
    __COMPRESSED_AUDIO_FIELD_NAME: Literal[b"compressed_audio"] = b"compressed_audio"
    __GRAVITY_FIELD_NAME: Literal[b"gravity"] = b"gravity"
    __GYROSCOPE_FIELD_NAME: Literal[b"gyroscope"] = b"gyroscope"
    __IMAGE_FIELD_NAME: Literal[b"image"] = b"image"
    __LIGHT_FIELD_NAME: Literal[b"light"] = b"light"
    __LINEAR_ACCELERATION_FIELD_NAME: Literal[b"linear_acceleration"] = b"linear_acceleration"
    __LOCATION_FIELD_NAME: Literal[b"location"] = b"location"
    __MAGNETOMETER_FIELD_NAME: Literal[b"magnetometer"] = b"magnetometer"
    __ORIENTATION_FIELD_NAME: Literal[b"orientation"] = b"orientation"
    __PRESSURE_FIELD_NAME: Literal[b"pressure"] = b"pressure"
    __PROXIMITY_FIELD_NAME: Literal[b"proximity"] = b"proximity"
    __RELATIVE_HUMIDITY_FIELD_NAME: Literal[b"relative_humidity"] = b"relative_humidity"
    __ROTATION_VECTOR: Literal[b"rotation_vector"] = b"rotation_vector"
