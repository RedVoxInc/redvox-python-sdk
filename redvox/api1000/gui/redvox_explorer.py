...
def packet_details(wrapped_packet: WrappedRedvoxPacketM) -> None:
    ...
    packet_tree: QTreeWidget = QTreeWidget()
    packet_tree.setColumnCount(2)
    ...
    app_settings_item.addChildren([
        ...
        QTreeWidgetItem(["additional_input_sensors", str(app_settings.get_additional_input_sensors().get_values())]),
    ...
    packet_tree.insertTopLevelItem(0, QTreeWidgetItem(["api", str(wrapped_packet.get_api())]))
    packet_tree.insertTopLevelItem(1, station_info_item)
    packet_tree.insertTopLevelItem(2, timing_info_item)
    packet_tree.insertTopLevelItem(3, sensors_item)
    packet_tree.insertTopLevelItem(4, make_metadata_item(wrapped_packet.get_metadata()))
...
def main() -> None:
    packet: WrappedRedvoxPacketM = WrappedRedvoxPacketM.from_compressed_path("/home/opq/scrap/api_m/0000000001_0.rdvxm")
