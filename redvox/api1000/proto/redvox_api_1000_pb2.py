...
_REDVOXPACKET1000_TIMINGINFORMATION = _descriptor.Descriptor(
  ...
  nested_types=[_REDVOXPACKET1000_TIMINGINFORMATION_SYNCHEXCHANGE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
