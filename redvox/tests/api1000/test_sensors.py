...
class TestSensor(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.non_empty_sensors.get_audio().get_samples().set_values(np.array([100.0, 50, 10.25], dtype=np.int))
        ...
        self.non_empty_sensors.get_pressure().get_timestamps().set_default_unit()
        ...
        self.non_empty_sensors.get_gyroscope().get_timestamps().set_default_unit()
